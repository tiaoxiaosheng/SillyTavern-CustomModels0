...
// fix if installed before vertexai support was added
if (!settings.provider.vertexai) settings.provider.vertexai = [];
if (!settings.vertexai_model) settings.vertexai_model = undefined;
